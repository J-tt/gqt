module github.com/j-tt/character-todo

go 1.18

require (
	github.com/centrifugal/centrifuge v0.30.3
...
// replace github.com/wailsapp/wails/v2 v2.6.0 => /Users/jett/.asdf/installs/golang/1.20/packages/pkg/mod
